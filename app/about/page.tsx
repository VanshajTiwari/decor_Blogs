...
return <>
            <header className="">
                <img src={"/img/aboutus.jpg"} alt=""  className="background"/>
            </header>

            <section className="bg-gray-200 text-green-900 md:p-10 flex flex-col items-center" style={{fontFamily:"'Quicksand'"}}>
                <h1 className="text-6xl">EXPERIENCE  BRILLIANCE</h1>
